        ...
        <div className={`ml-12 md:ml-0 md:w-1/2 ${index % 2 === 0 ? "md:pr-12" : "md:pl-12"}`}>
            <div className="bg-white job dark:bg-gray-900 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-3">
                    ...
                    <div className="flex quote items-center text-sm text-gray-500 dark:text-gray-400 mt-1 sm:mt-0">
                ...
                <div className="flex  items-center text-blue-600 dark:text-blue-400 mb-3">
                    <span className="font-semibold quote">{exp.company}</span>
                    <span className="mx-2 quote">•</span>
                    <div className="flex items-center quote">
                        <MapPin size={16} className="mr-1 quote" />
                        {exp.location}
                    </div>
                </div>
