    ...
    <section id="contact" className="py-20 bg-white dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4 animate-fadeInUp">Get In Touch</h2>
            ...
            <div className="space-y-6 mb-8">
              {contactInfo.map(({ icon: Icon, title, value, href }) => (
                <div key={title} className="flex items-center space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold  connect text-gray-900 dark:text-white">{title}</h4>
                    <a
                      href={href}
                      className="text-gray-600 contact dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200"
                    >
                      {value}
                    </a>
                  </div>
